...
# Load the model
model_file_path = "rough.h5"  # Change this path accordingly
...
def main():
    ...
    webrtc_ctx = webrtc_streamer(key="example", video_processor_factory=VideoTransformer, async_processing=True)
